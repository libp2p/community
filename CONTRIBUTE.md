...
libp2p is an Open Source project and we welcome contributions of all sorts.
...
If you find bugs, mistakes, inconsistencies in the libp2p specs, code or
...
Protocol Labs occasionally is able to hire developers for part time or full time positions, to work on libp2p. If you are interested, check out [the job listings](http://ipn.io/join/#pm). If you'd like to help in other ways, [email @jbenet directly](mailto:juan@ipfs.io?subject=Contributing to libp2p).
